...
class Processor(Iface, TProcessor):
    ...
    def process_fetchOperations(self, seqid, iprot, oprot):
        ...
        try:
            ...
            msg_type = TMessageType.REPLY
            result.e = e
        except ShouldSyncException as s:
            msg_type = TMessageType.REPLY
            result.s = s
...
class fetchOperations_result(object):
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i2105 in range(_size2101):
                        _elem2106 = Operation()
                        _elem2106.read(iprot)
                        self.success.append(_elem2106)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter2107 in self.success:
                iter2107.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
fetchOperations_result.thrift_spec = (
    ...
    (2, TType.STRUCT, 's', [ShouldSyncException, None], None, ),  # 2
)
...
class fetchOps_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    self.success = []
                    (_etype2111, _size2108) = iprot.readListBegin()
                    for _i2112 in range(_size2108):
                        _elem2113 = Operation()
                        _elem2113.read(iprot)
                        self.success.append(_elem2113)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRUCT, len(self.success))
            for iter2114 in self.success:
                iter2114.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
