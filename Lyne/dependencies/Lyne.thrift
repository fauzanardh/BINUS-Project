/****line.thrift****
| Updated Line Thrift
| Original Author: GoogleX, Alin
| Updated by: FauzanArdh-
| Copyright (c) 2018
*/
namespace py Lyne
enum AuthErrorCode {
...
enum ErrorCode {
    ...
    SEND_MESSAGE_NOT_PERMITTEDfrom__LINE_AT = 75;
...
enum OpType {
    ...
    KICKOUTfrom__GROUP = 18;
    NOTIFIED_KICKOUTfrom__GROUP = 19;
    CREATE_ROOM = 20;
    INVITE_INTO_ROOM = 21;
...
enum SettingsAttributeEx {
    ...
    PRIVACY_RECV_MESSAGESfrom__NOT_FRIEND = 25;
...
enum SettingsAttribute {
    ...
    PRIVACY_RECV_MESSAGESfrom__NOT_FRIEND = 33554432;
...
enum ShopRecommendationType {
    UNKNOWN = 0;
    PRODUCT = 1;
    USER = 2;
}
enum ShopShowcaseType {
    POPULAR = 0;
    NEW_RELEASE = 1;
    EVENT = 2;
    RECOMMENDED = 3;
...
enum SquareEventType {
    ...
    NOTIFIED_KICKOUTfrom__SQUARE = 19;
...
exception AuthException {
    ...
    3: WebAuthDetails webAuthDetails;
}
...
exception SquareBotException {
    1: SquareBotErrorCode errorCode;
    2: string reason;
    3: map<string, string> parameterMap;
}
...
struct GetRecommendationRequest {
    ...
    2: i32 limit;
    3: ShopProductType productType;
    4: ShopRecommendationType recommendationType;
    5: string productId;
    6: set<ShopSubType> subtypes;
}
...
struct GetSuggestDictionarySettingResponse {
    1: SuggestDictionarySetting results;
}
...
struct ProductDetail {
    ...
    64: ShopPrice localizedPrice;
    91: map<string, string> images;
...
struct ProductSubscriptionProperty {
    ...
    2: SubscriptionAvailability subscriptionAvailability;
}
...
struct ProductTypeSummary {
    ...
    3: StickerSummary sticonSummary;
}
...
struct ShowcaseRequest {
    1: ShopProductType productType;
    2: ShopShowcaseType showcaseType;
    3: ShopSubType subType;
    4: string continuationToken;
    5: i32 limit;
}
struct ShowcaseV3 {
...
service PollService {
    list<Operation> fetchOperations(
        2: i64 localRev,
        3: i32 count) throws(1: TalkException e, 2: ShouldSyncException s);
    list<Operation> fetchOps(
        2: i64 localRev,
        3: i32 count,
        4: i64 globalRev,
        5: i64 individualRev) throws (1: TalkException e, 2: ShouldSyncException s);
    i64 getLastOpRevision() throws(1: TalkException e);
}
service PrimaryAccountInitService {
    string openSession(
        1: OpenSessionRequest req
...
service ShopService {
    ...
    void notifyProductEvent(
        ...
        5: i64 productEvent) throws (1: ShopException e)
    ShowcaseV3 getShowcaseV3(
        1: ShowcaseRequest showcaseRequest) throws (1: ShopException e)
    ProductDetail getProductUShop(
        2: string shopId,
        3: string productId,
        4: ShopLocale locale) throws (1: ShopException e)
    GetProductResponse getProductV2(
        2: GetProductRequest request) throws (1: ShopException e)
    ProductDetail getProductByVersion(
        2: string shopId,
        3: string productId,
        4: i64 productVersion,
        5: ShopLocale locale) throws (1: ShopException e)
    PurchaseOrderResponse placePurchaseOrderForFreeProduct(
        2: PurchaseOrder purchaseOrder) throws (1: ShopException e)
    ...
    ProductValidationScheme getProductValidationScheme(
        2: string shopId,
        3: string productId,
        4: i32 productVersion) throws (1: ShopException e)
    ProductValidationResult validateProduct(
        2: string shopId,
        3: string productId,
        4: i64 productVersion,
        5: ProductValidationRequest validationReq) throws (1: ShopException e)
    ShopUpdates getUpdates(
        2: string shopId,
        3: ShopLocale locale) throws (1: ShopException e)
    ShopProductList getRecommendationForUser(
        2: string shopId,
        3: i32 offset,
        4: i32 limit,
        5: ShopLocale locale) throws (1: ShopException e)
    GetRecommendationResponse getRecommendationList(
        2: GetRecommendationRequest getRecommendationRequest) throws (1: ShopException e)
    void buyMustbuyProductUShop(
        2: BuyMustbuyRequest request) throws (1: ShopException e)
    ShopProductList getProductsByAuthor(
        2: ProductListByAuthorRequest productListByAuthorRequest) throws (1: ShopException e)
    AutoSuggestionShowcaseResponse getAutoSuggestionShowcase(
        2: AutoSuggestionShowcaseRequest autoSuggestionShowcaseRequest) throws (1: ShopException e)
    GetSuggestDictionarySettingResponse getSuggestDictionarySetting(
        2: GetSuggestDictionarySettingRequest req) throws (1: ShopException e)
    GetRecommendOaResponse getRecommendOa(
        2: GetRecommendOaRequest req) throws (1: ShopException e)
    GetSuggestResourcesV2Response getSuggestResourcesV2(
        2: GetSuggestResourcesV2Request req) throws (1: ShopException e)
    GetOldSticonMappingResponse getOldSticonMapping(
        2: GetOldSticonMappingRequest req) throws (1: ShopException e)
}
...
service SquareBotService {
    GetSquareBotResponse getSquareBot(
        1: GetSquareBotRequest req) throws (1: SquareBotException e)
}
service TalkService {
    SearchResult searchCollection(
        1: string query,
